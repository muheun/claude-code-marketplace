...
- External string enum inputs are parsed at the app boundary. Use reusable domain enum factories only for web-neutral canonical tokens; keep channel-specific aliases, defaults, localization, and response messages out of reusable domain enums.
